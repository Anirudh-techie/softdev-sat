      ...
      {windowClosed ? (
        <div>
          <div
            ...
            className="w-12 h-12 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer bg-gradient-to-br from-amber-500 to-amber-400 hover:from-amber-300 hover:to-amber-400 rounded-xl shadow-xl hover:shadow-amber-500/25 transition-all duration-300 hover:scale-110 group"
          >
